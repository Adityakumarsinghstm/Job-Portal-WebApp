...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="view_jobs.jsp"><i class="fa fa-eye"></i> View Job</a></li>
			</c:if>
		...
		<a href="#" class="btn btn-light mr-2"><i class="fa-solid fa-user"></i> Admin</a>
		  <a href="#" class="btn btn-light"><i class="fa fa-sign-in-alt"></i> Logout</a>
		</c:if>
		  <c:if test="${ empty userobj }">
		<a href="login.jsp" class="btn btn-light mr-2"><i class="fa fa-sign-in-alt"></i> Login</a>
